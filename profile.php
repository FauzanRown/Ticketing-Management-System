...
<body class="main-body">
  <aside class="sidebar">
    ...
    <div class="menu-section">
      ...
      <nav class="menu-list">
        <a href="index.php" class="link-tombol">
        ...
        <a href="dataPenumpangKereta.php" class="link-tombol">
          <div class="nav-tombol">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <a href="profile.php" class="link-tombol">
          <div class="nav-tombol">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor"
  ...
  <div class="content-card-profile">
    <div class="card-profile-header">
      <div class="foto-profile">
        <img src="profile.png" style="width: 140px; border-radius: 50%;" alt="">
=======
  <div style="display: grid; grid-template-columns: 1fr; margin-left: 80px; padding: 20px;">
...
>>>>>>> a9dcfe1cec3d270b6d1f575e40f42d6b22aee1ac:public/profile.php
      </div>
    ...
    <div class="content-card">
      <div class="card-profile-header">
        <div class="foto-profile">
          <img src="../image/profile2.jpg" style="width: 140px; border-radius: 50%;" alt="">
        </div>
        <h1 style="text-align: center; padding-top: 10px; padding-bottom: 7px;">Muhammad Faizin Allbahri</h1>
