...
<body class="main-body">
  ...
  <div class="content-card">
    <div class="card-penumpang">
      ...
      <div class="display-ticket tiket-item" style="display: block;">
        ...
        <div class="ticket-penumpang-body">
          <img src="Logo KAI.png" alt="" class="logo-kai" />
      ...
      <?php endforeach; ?>
      <?php else: ?>
      <p style="color: white; text-align: center;">Belum ada data pemesanan.</p>
      <?php endif; ?>
